				...
				<div class="panel-body">
					...
					action="${contextRoot}/manage/products" method="POST">
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<sf:input type="number" path="unitPrice" placeholder="Unit price in &#36" class="form-control"/>
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<sf:input type="number" path="quantity" placeholder="Quantity Available" class="form-control"/>
							</div>
						</div>
